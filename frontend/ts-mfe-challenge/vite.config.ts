...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: isTest ? [
      { find: /^monaco-editor($|\/)/, replacement: path.resolve(__dirname, './__mocks__/monaco-editor.tsx') },
      { find: /^@monaco-editor\/react($|\/)/, replacement: path.resolve(__dirname, './__mocks__/monaco-editor.tsx') },
