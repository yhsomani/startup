...
export const CollaborativeEditor: React.FC<CollaborativeEditorProps> = ({
    ...
    useEffect(() => {
        ...
        const initEditor = () => {
            ...
            // Use local IP/hostname or localhost if robust networking setup
            provider = new WebsocketProvider('ws://localhost:8000/ws/', roomId, doc);
    ...
    return (
        <div className="flex flex-col h-full">
            <div className={`text-xs px-2 py-1 ${status === 'connected' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
