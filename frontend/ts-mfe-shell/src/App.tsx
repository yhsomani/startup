...
const RecruiterDashboard = lazy(() =>
    import("./components/RecruiterDashboard").then(m => ({ default: m.RecruiterDashboard }))
);
            ...
            {isAuthenticated && (
                <>
                    ...
                    <Link
                        to="/gamification"
                        style={
                            location.pathname === "/gamification" ? activeLinkStyle : navLinkStyle
                        }>
                        🏆 Achievements
                    </Link>
                </>
            ...
            {hasRole(["RECRUITER", "ADMIN"]) && (
                <>
                    ...
                    <Link
                        ...
                        style={
                            location.pathname === "/jobs/manage" ? activeLinkStyle : navLinkStyle
                        }>
                        Jobs
                    </Link>
                    <Link
                        ...
                        style={
                            location.pathname === "/candidates" ? activeLinkStyle : navLinkStyle
                        }>
                        Candidates
                    </Link>
                    <Link
                        ...
                        <Routes>
                            ...
                            <Route
                                ...
                                element={
                                    <ProtectedRoute allowedRoles={["RECRUITER", "ADMIN"]}>
                                        <div style={{ padding: "2rem" }}>
                                            <h2 data-testid="analytics-header">
                                                Analytics Dashboard
                                            </h2>
                                            <div
                                                data-testid="job-performance-metrics"
                                                style={{
                                                    background: "white",
                                                    padding: "1.5rem",
                                                    borderRadius: "12px",
                                                ...
                                                <div
                                                    data-testid="applications-chart"
                                                    style={{
                                                        height: "200px",
                                                        background: "#f8fafc",
                                                        borderRadius: "8px",
                                            ...
                                            <div
                                                data-testid="application-funnel"
                                                style={{
                                                    background: "white",
                                                    padding: "1.5rem",
                                                    borderRadius: "12px",
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        data-testid="source-distribution-chart"
                                                        style={{
                                                            height: "150px",
                                                            background: "#f8fafc",
                                                            borderRadius: "8px",
                                            ...
                                            <div style={{ marginTop: "2rem" }}>
                                                ...
                                                <div style={{ display: "none" }}>
                                                    ...
                                                    <button data-testid="apply-date-filter">
                                                        Apply
                                                    </button>
                                                </div>
                                                <p
                                        ...
                                        <div
                                            ...
                                            <form
                                                onSubmit={async e => {
                                                    ...
                                                    const msg =
                                                        document.getElementById("job-success-msg");
                                        ...
                                        <div style={{ padding: "2rem" }}>
                                            ...
                                            <div
                                                    ...
                                                    {[
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                />
                                                                <div style={{ display: "none" }}>
                                                                    <select data-testid="bulk-status">
                                                                        <option value="Rejected">
                                                                            Rejected
                                                                        </option>
                                                                    </select>
                                                                    <button data-testid="apply-bulk-action">
                                                                        Apply
                                                                    </button>
                                                                    <button
                                                ...
                                                <div
                                                    ...
                                                    <h2 data-testid="candidate-name">
                                                        Alice Smith
                                                    </h2>
                                                    <p data-testid="candidate-email">
                                                        alice@example.test
                                                    </p>
                                                    <div
                                                    ...
                                                    <button
                                                        data-testid="interview-schedule"
                                                        onClick={() => {
                                                            const el =
                                                                document.getElementById(
                                                                    "sched-list"
