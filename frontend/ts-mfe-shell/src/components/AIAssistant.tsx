            ...
            <div style={{
                ...
                {messages.map((msg, idx) => (
                    <div key={idx} style={{
                        ...
                        background: msg.role === 'user' ? 'linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%)' : 'white',
            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        ...
                        background: loading || !input.trim() ? '#d1d5db' : 'linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%)',
                        color: 'white',
                        border: 'none',
                        borderRadius: '8px',
