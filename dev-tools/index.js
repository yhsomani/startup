...
class DevTools extends EventEmitter {
  ...
  async startService(serviceName) {
    const span = this.tracer ? this.tracer.startSpan(`devtools.service.start.${serviceName}`) : null;
  ...
  async stopService(serviceName) {
    const span = this.tracer ? this.tracer.startSpan(`devtools.service.stop.${serviceName}`) : null;
